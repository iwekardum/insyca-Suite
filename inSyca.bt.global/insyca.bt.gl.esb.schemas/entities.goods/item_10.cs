namespace insyca.bt.gl.esb.schemas.entities.goods {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.goods.article_10",@"article")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"article"})]
    public sealed class article_10 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.goods.article_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.goods.article_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""article"" nillable=""true"">
    <xs:annotation>
      <xs:appinfo>
    ...
    <xs:complexType>
      <xs:sequence minOccurs=""0"" maxOccurs=""1"">
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""isstockitem"" nillable=""true"" type=""xs:boolean"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Lagerartikel"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
      </xs:sequence>
