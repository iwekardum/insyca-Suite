namespace insyca.bt.gl.esb.schemas.entities.roles {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.roles.customer_10",@"customer")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"customer"})]
    public sealed class customer_10 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.roles.customer_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.roles.customer_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""customer"" nillable=""true"">
    <xs:annotation>
      <xs:appinfo>
        <b:recordInfo notes=""Kunde"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" />
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
