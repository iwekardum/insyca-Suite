namespace insyca.bt.gl.esb.schemas.entities.business.logistics {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.business.logistics.package_10",@"package")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"package"})]
    public sealed class package_10 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.business.logistics.package_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.business.logistics.package_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""package"" nillable=""true"">
    <xs:annotation>
      <xs:appinfo>
        <b:recordInfo notes=""Packstück, Kolli, Verpackungseinheit"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" />
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
