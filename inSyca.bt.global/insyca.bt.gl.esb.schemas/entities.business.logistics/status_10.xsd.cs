namespace insyca.bt.gl.esb.schemas.entities.business.logistics {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.business.logistics.status_10",@"status")]
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.business.logistics.status_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.business.logistics.status_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""status"" nillable=""true"">
    <xs:annotation>
      <xs:appinfo>
        <b:recordInfo notes=""Sendungsstatus"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" />
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence minOccurs=""0"" maxOccurs=""1"">
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""type"" nillable=""true"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Kennzeichen um welche Daten es sich handelt: Scandaten; Auslieferdaten; Fehlerdaten; Abrechnungsdaten"" />
            </xs:appinfo>
          </xs:annotation>
          <xs:simpleType>
            <xs:restriction base=""xs:string"">
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""date"" nillable=""true"" type=""xs:date"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Datum, wann der Status erzeugt wurde"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""time"" nillable=""true"" type=""xs:time"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Uhrzeit, wann der Status erzeugt wurde"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""code"" nillable=""true"" type=""xs:string"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Statuscode"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""name"" nillable=""true"" type=""xs:string"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Freitext zum Statuscode"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
