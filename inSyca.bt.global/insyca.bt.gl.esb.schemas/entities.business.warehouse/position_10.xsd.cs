namespace insyca.bt.gl.esb.schemas.entities.business.warehouse {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.business.warehouse.position_10",@"position")]
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.business.warehouse.position_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" elementFormDefault=""qualified"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.business.warehouse.position_10"" id=""position_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""position"">
    <xs:complexType>
      <xs:sequence minOccurs=""0"" maxOccurs=""1"">
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""position"" nillable=""true"" type=""xs:string"">
          <xs:annotation>
            <xs:appinfo>
              <b:fieldInfo notes=""Position"" />
            </xs:appinfo>
          </xs:annotation>
        </xs:element>
      </xs:sequence>
