namespace insyca.bt.gl.esb.schemas.entities.law {
    ...
    [Schema(@"http://insyca.bt.gl.esb.schemas.entities.law.legalperson_10",@"legalperson")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"legalperson"})]
    public sealed class legalperson_10 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns=""http://insyca.bt.gl.esb.schemas.entities.law.legalperson_10"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://insyca.bt.gl.esb.schemas.entities.law.legalperson_10"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""legalperson"">
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""name3"" type=""xs:string"">
          <xs:annotation>
            <xs:appinfo>
