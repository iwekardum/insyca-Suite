...
namespace inSyca.foundation.communication.configurator
{
    ...
    {
        internal uc_information_clients(configXml _configFile, List<framework.diagnostics.Information> _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }

        internal uc_information_clients(configXml _configFile, framework.diagnostics.Information _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }
