...
namespace inSyca.foundation.communication.configurator
{
    ...
    {
        internal uc_information_service(configXml _configFile, List<Information> _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }

        internal uc_information_service(configXml _configFile, Information _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }
