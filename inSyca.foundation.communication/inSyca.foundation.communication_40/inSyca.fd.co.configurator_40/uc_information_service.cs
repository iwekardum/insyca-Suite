...
{
    public partial class uc_information_service : uc_info
    {
        internal uc_information_service(configXml _configFile, List<IInformation> _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }

        internal uc_information_service(configXml _configFile, IInformation _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }
        ...
        override protected void LoadConfiguration()
        {
            ...
            propertyComponent.AddProperty("Foundation Communication Service Version", information[1].Version, string.Empty, "inSyca Foundation", typeof(string), true, false);
