...
namespace BizTalkDocumentation
{
    ...
    /// </summary>
    internal class OrchestrationsTopic : TopicFile
    {
        public OrchestrationsTopic()
        {
            Title = "Orchestrations";
            LinkTitle = "Orchestrations";
            LinkUri = "##Orchestrations";
            TopicType = TopicType.Orchestrations;
        }
