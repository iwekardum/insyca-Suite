...
namespace BizTalkDocumentation
{
    ...
    /// </summary>
    internal class SendPortGroupsTopic : TopicFile
    {
        public SendPortGroupsTopic()
        {
            Title = "SendPortGroups";
            LinkTitle = "SendPortGroups";
            LinkUri = "##SendPortGroups";
            TopicType = TopicType.SendPortGroups;
        }
