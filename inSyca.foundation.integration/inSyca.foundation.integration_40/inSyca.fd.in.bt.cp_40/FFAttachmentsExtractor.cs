    ...
    public class FFAttachmentsExtractor : FFDasmComp, IBaseComponent, IComponentUI, IDisassemblerComponent, IPersistPropertyBag
    {
        ...
        public new IBaseMessage GetNext(IPipelineContext pipelineContext)
        {
            ...
            if (_msgs.Count > 0)
            {
                ...
                return msg;
                //return base.GetNext(pipelineContext);
            }
            else
            {
            ...
            //    Stream messageStream = msg.BodyPart.GetOriginalDataStream();
            //    messageStream.Seek(0, SeekOrigin.Begin);

            //    StreamReader sr = new StreamReader(msg.BodyPart.GetOriginalDataStream());
            //    string messageString = sr.ReadToEnd();
            //    Log.DebugFormat("messageString {0}", messageString);
