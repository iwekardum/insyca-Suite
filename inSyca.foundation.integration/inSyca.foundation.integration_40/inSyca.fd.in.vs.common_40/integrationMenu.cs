    ...
    internal sealed class integrationMenu
    {
        ...
        private integrationMenu(Package package)
        {
            ...
            if (commandService != null)
            {
                ...
                var odxContextMenuCommandID = new CommandID(publicODXContextMenuCommandSet, ODXCommandId);
                ...
                var fixContextMenuCommandID = new CommandID(gacProjectContextMenuCommandSet, fixODXCommandId);
                ...
                var gacContextMenuCommandID = new CommandID(gacProjectContextMenuCommandSet, GACCommandId);
                ...
                var referenceContextMenuCommandID = new CommandID(gacReferenceContextMenuCommandSet, GACCommandId);
