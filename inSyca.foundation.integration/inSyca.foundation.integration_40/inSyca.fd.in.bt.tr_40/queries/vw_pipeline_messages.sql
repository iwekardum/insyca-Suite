...
WHERE        (BizTalkDTADb.dbo.dtav_ServiceFacts.[Service/Type] = N'Pipeline') AND BizTalkDTADb.dbo.dtav_FindMessageFacts.[Event/Timestamp] BETWEEN '{0:yyyy-MM-dd hh:MM:ss.fff}' AND '{1}'
