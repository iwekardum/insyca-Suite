...
namespace inSyca.foundation.integration.biztalk.adapter.file.runtime
{
    ...
    /// </summary>
    public class Receiver : common.Receiver 
    {
        public Receiver () : base(
            ...
            ".NetFILE",
            new Guid("62E68109-C8B0-43B2-A708-0DDB301F5972"),
            "http://schemas.microsoft.com/BizTalk/2003/dotnetfile-properties",
            typeof(ReceiverEndpoint))
        {
        }
        /// <summary>
        ...
        protected override void HandlerPropertyBagLoaded ()
        {
            ...
            if (null != config)
            {
                ...
                {
                    ReceiveProperties.ReceiveHandlerConfiguration(handlerConfigDom);
                }
            }
        }
    }
