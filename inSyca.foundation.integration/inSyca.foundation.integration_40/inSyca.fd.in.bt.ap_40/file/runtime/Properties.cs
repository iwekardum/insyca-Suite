...
namespace inSyca.foundation.integration.biztalk.adapter.file.runtime
{
    ...
    /// </summary>
    internal abstract class CommonProperties : ConfigProperties
    {
    ...
    /// </summary>
    internal class ReceiveProperties : CommonProperties
    {
		// Handler properties
	...
	/// </summary>
    internal class TransmitProperties : CommonProperties
    {
		// Handler properties
        ...
        public TransmitProperties(IBaseMessage message, string propertyNamespace)
		{
		...
		public void UpdateUriForDynamicSend()
		{
			if (!String.IsNullOrEmpty(this.Uri))
			{
				...
				const string adapterAlias = "DotNetFILE://";
