...
namespace inSyca.foundation.integration.biztalk.adapter.file.design
{
    ...
    public class DynamicAdapterManagement : IAdapterConfig, IDynamicAdapterConfig 
	{
        ...
        private static ResourceManager resourceManager = new ResourceManager("inSyca.foundation.integration.biztalk.adapter.file.design.Resource", Assembly.GetExecutingAssembly());
        ...
        public string GetConfigSchema(ConfigType type) 
		{
            switch (type) 
			{
				case ConfigType.ReceiveHandler:
                    return LocalizeSchema(GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.ReceiveHandler.xsd"), resourceManager);

				case ConfigType.ReceiveLocation:
                    return LocalizeSchema(GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.ReceiveLocation.xsd"), resourceManager);

				case ConfigType.TransmitHandler:
                    return LocalizeSchema(GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.TransmitHandler.xsd"), resourceManager);

				case ConfigType.TransmitLocation:
                    return LocalizeSchema(GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.TransmitLocation.xsd"), resourceManager);
            ...
            out string [] WSDLList) 
		{
            ...
            WSDLList[0] = GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.service1.wsdl");
            return Result.Continue;
        }
    ...
    public class StaticAdapterManagement : IAdapterConfig, IStaticAdapterConfig, IAdapterConfigValidation 
	{
        ...
        public string[] GetServiceDescription(string[] wsdls) 
		{
            ...
            result[0] = GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.service1.wsdl");
            return result;
        }
		...
		{
            string result = GetResource("inSyca.foundation.integration.biztalk.adapter.file.design.CategorySchema.xml");
            return result;
        }
