...
{
    public partial class uc_test_integration_biztalk_functions : uc_test
    {
        internal uc_test_integration_biztalk_functions()
        {
            InitializeComponent();
        }

        public uc_test_integration_biztalk_functions(configXml _configFile)
            : base(_configFile)
        {
            InitializeComponent();
