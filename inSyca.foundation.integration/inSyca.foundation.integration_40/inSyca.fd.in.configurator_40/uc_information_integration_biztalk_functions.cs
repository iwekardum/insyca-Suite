...
namespace inSyca.foundation.integration.configurator
{
    ...
    {
        internal uc_information_integration_biztalk_functions(configXml _configFile, List<IInformation> _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }

        internal uc_information_integration_biztalk_functions(configXml _configFile, IInformation _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }
