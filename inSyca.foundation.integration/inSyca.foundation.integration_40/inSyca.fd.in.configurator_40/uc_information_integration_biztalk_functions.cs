...
{
    public partial class uc_information_integration_biztalk_functions : uc_info
    {
        internal uc_information_integration_biztalk_functions(configXml _configFile, List<framework.diagnostics.Information> _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }

        internal uc_information_integration_biztalk_functions(configXml _configFile, framework.diagnostics.Information _information)
            : base(_configFile, _information)
        {
            InitializeComponent();
        }
        ...
        override protected void LoadConfiguration()
        {
            ...
            propertyComponent.AddProperty("Foundation Integration BizTalk Functions Version", information[1].Version, string.Empty, "inSyca Foundation", typeof(string), true, false);
