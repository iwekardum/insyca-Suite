...
{
    public partial class uc_test_integration_biztalk_adapter : uc_test
    {
        internal uc_test_integration_biztalk_adapter()
        {
            InitializeComponent();
        }

        public uc_test_integration_biztalk_adapter(configXml _configFile)
            : base(_configFile)
        {
            InitializeComponent();
