...
namespace inSyca.foundation.framework.application.windowsforms
{
	...
	public class PropertyComponent : Component, ICustomTypeDescriptor
	{
		public static Type GetValueType(string value)
		{
			Int32 propInt;

			if (Int32.TryParse(value, out propInt))
				return typeof(Int32);

			bool propBoolean;

			if (bool.TryParse(value, out propBoolean))
				return typeof(bool);
		...
		public void AddProperty(FoundationProperty foundationProperty)
		{
			DynamicProperty p = new DynamicProperty(foundationProperty.xElement, foundationProperty.propName, foundationProperty.propValueName, foundationProperty.propValue, foundationProperty.propDesc, foundationProperty.propCat,
				foundationProperty.propType, foundationProperty.isReadOnly, foundationProperty.isExpandable);
			propertyCollection.Add(p);
		}


	//    public void AddProperty(XElement xElement, string propValueName, string propName, object propValue, string propDesc, 
	//        string propCat,  System.Type propType, bool isReadOnly, bool isExpandable)
	//    {
	//        DynamicProperty p = new DynamicProperty(xElement, propName, propValueName, propValue, propDesc, propCat, 
	...
	//    public void AddProperty(XElement xElement, string propName, object propValue, string propDesc,
	//string propCat, System.Type propType, bool isReadOnly, bool isExpandable)
	//    {
	//        DynamicProperty p = new DynamicProperty(xElement, propName, propName, propValue, propDesc, propCat,
	//            propType, isReadOnly, isExpandable);
	//        propertyCollection.Add(p);
	//        //Set our layout helper value.
	//        this.MaxLength = propName.Length;
	...
	string propCat, System.Type propType, bool isReadOnly, bool isExpandable)
		{
			DynamicProperty p = new DynamicProperty(propName, propName, propValue, propDesc, propCat,
				propType, isReadOnly, isExpandable);
			propertyCollection.Add(p);
			//Set our layout helper value.
			this.MaxLength = propName.Length;
		...
		public class DynamicProperty : PropertyDescriptor
		{
			...
			public XElement propElement { get; set; }
			public string propValueName { get; set; }

			public DynamicProperty(XElement pElement, string pValueName, string pName, object pValue, string pDesc, string pCat, Type pType, bool readOnly, bool expandable)
				: base(pName, new Attribute[] { })
			{
				propValueName   = pValueName;
				propElement     = pElement;
				propName        = pName;
				propValue       = pValue;
			...
			public DynamicProperty(string pValueName, string pName, object pValue, string pDesc, string pCat, Type pType, bool readOnly, bool expandable)
				: base(pName, new Attribute[] { })
			{
				propValueName   = pValueName;
				propName        = pName;
	...
	public class FoundationProperty
	{
		...
		public string propCat { get; set; }
		public System.Type propType { get; set; }
